...
2. Catégorie B critique : `ENVIRONMENT`, `AWS_*` (fallbacks S3), `LABEL_STUDIO_SSL_VERIFY` utilisées en prod potentiel mais non documentées.
...
- Vérification Railway dashboard Phase 2 : prioriser Catégorie A (21 vars alignées) + Catégorie B critique (`ENVIRONMENT`, `AWS_*`, `LABEL_STUDIO_SSL_VERIFY`).
