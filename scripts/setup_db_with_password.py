...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Setup DMS PostgreSQL avec mot de passe"
    )
    parser.add_argument(
        "--password",
        default="",
        help="Mot de passe PostgreSQL superuser (requis si non fourni via variable d'environnement PGPASSWORD)",
    )
    parser.add_argument(
        "--superuser", default="postgres", help="Nom de l'utilisateur superuser"
    )
    ...
    parser.add_argument(
        "--db-password",
        default="dms_dev_password_change_me",
        help="Mot de passe utilisateur DB",
    )
    ...
    if not password:
        ...
        if not password:
            ...
            print(
                "  OU via variable d'environnement: $env:PGPASSWORD = 'votre_mot_de_passe'"
            )
            sys.exit(1)
