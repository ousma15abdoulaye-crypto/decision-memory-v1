...
ENTRIES = [
    ...
    (
        11,
        "DGMP goods procurement AOO Bamako, 50M XOF",
        "dgmp",
        "goods",
        50_000_000,
        "XOF",
    ...
    (
        12,
        "DGMP services, Mopti, 8M XOF, below AOO threshold",
        "dgmp",
        "services",
        8_000_000,
        "XOF",
        ...
        "dgmp",
        ["demande_cotation", "consultation_restreinte"],
        9,
        True,
        0,
        None,
    ...
    (
        13,
        "DGMP works, Bamako, 120M XOF, construction",
        "dgmp",
        "works",
        120_000_000,
        "XOF",
    ...
    (
        14,
        "DGMP goods, Kidal, 30M XOF, security zone",
        "dgmp",
        "goods",
        30_000_000,
        "XOF",
        ...
        "dgmp",
        ["appel_offres_restreint", "entente_directe"],
        9,
        True,
        None,
        1,
    ...
    (
        15,
        "DGMP services, Tombouctou, no value, security",
        "dgmp",
        "services",
        None,
        "XOF",
        ...
        "dgmp",
        ["appel_offres_ouvert", "appel_offres_restreint", "entente_directe"],
        9,
        True,
        None,
        1,
    ...
    (
        16,
        "SCI services, Bamako, USD 5000, IT services",
        "sci",
        "services",
        5_000,
        "USD",
    ...
    (
        17,
        "SCI services, Mopti, USD 120000, consultancy",
        "sci",
        "services",
        120_000,
        "USD",
        ...
        "sci",
        ["open_international", "open_national"],
        9,
        True,
        0,
        None,
    ...
    (
        18,
        "SCI goods, Kidal, USD 8000, humanitarian",
        "sci",
        "goods",
        8_000,
        "USD",
        ...
        "sci",
        ["request_for_quotation", "direct_procurement"],
        9,
        True,
        None,
        1,
    ...
    (
        19,
        "SCI works, Bamako, USD 200000, construction rehab",
        "sci",
        "works",
        200_000,
        "USD",
    ...
    (
        20,
        "SCI services, Tombouctou, USD 45000, logistics",
        "sci",
        "services",
        45_000,
        "USD",
    ...
    (
        21,
        "SCI goods, entente directe, sole source, Bamako",
        "sci",
        "goods",
        3_000,
        "USD",
        ...
        "sci",
        ["direct_procurement", "request_for_quotation"],
        9,
        True,
        None,
        1,
    ...
    (
        22,
        "DGMP services, entente directe, emergency, Mopti",
        "dgmp",
        "services",
        5_000_000,
        "XOF",
    ...
    (
        23,
        "DGMP goods, emergency flood relief, Mopti",
        "dgmp",
        "goods",
        15_000_000,
        "XOF",
    ...
    (
        24,
        "SCI goods, emergency nutrition, Kidal",
        "sci",
        "goods",
        50_000,
        "USD",
    ...
    (
        25,
        "DGMP works, emergency bridge repair, Gao",
        "dgmp",
        "works",
        40_000_000,
        "XOF",
    ...
    (
        26,
        "DGMP AOI goods, high value, Bamako",
        "dgmp",
        "goods",
        500_000_000,
        "XOF",
    ...
    (
        27,
        "SCI AOI services, Bamako, USD 500k",
        "sci",
        "services",
        500_000,
        "USD",
    ...
    (
        28,
        "DGMP AOI works, construction, Bamako, 1B XOF",
        "dgmp",
        "works",
        1_000_000_000,
        "XOF",
    ...
    (
        29,
        "SCI goods, Menaka, USD 12000, insecure zone",
        "sci",
        "goods",
        12_000,
        "USD",
    ...
    (
        30,
        "DGMP services, Taoudenit, 6M XOF, remote",
        "dgmp",
        "services",
        6_000_000,
        "XOF",
        ...
        "dgmp",
        ["consultation_restreinte", "entente_directe"],
        9,
        True,
        None,
        1,
    ...
    (
        31,
        "SCI works, Menaka, USD 80000, humanitarian",
        "sci",
        "works",
        80_000,
        "USD",
    ...
    (
        32,
        "SCI goods, USD 24999, just below ITB threshold",
        "sci",
        "goods",
        24_999,
        "USD",
        ...
        "sci",
        ["request_for_quotation", "open_national"],
        9,
        True,
        0,
        None,
    ...
    (
        33,
        "SCI goods, USD 25001, just above ITB threshold",
        "sci",
        "goods",
        25_001,
        "USD",
        ...
        "sci",
        ["open_national", "open_international"],
        9,
        True,
        0,
        None,
    ...
    (
        34,
        "DGMP goods, 74999999 XOF, just below AOO threshold",
        "dgmp",
        "goods",
        74_999_999,
        "XOF",
        ...
        "dgmp",
        ["consultation_restreinte", "demande_cotation"],
        9,
        True,
        0,
        None,
    ...
    (
        35,
        "DGMP goods, 75000001 XOF, just above AOO threshold",
        "dgmp",
        "goods",
        75_000_001,
        "XOF",
    ...
    (
        36,
        "SCI goods multi-lot, Bamako, USD 45000 total",
        "sci",
        "goods",
        45_000,
        "USD",
        ...
        "sci",
        ["open_national", "request_for_quotation"],
        9,
        True,
        0,
        None,
    ...
    (
        37,
        "DGMP services multi-lot, Bamako, 200M XOF",
        "dgmp",
        "services",
        200_000_000,
        "XOF",
        ...
        "dgmp",
        ["appel_offres_ouvert", "appel_offres_international"],
        9,
        True,
        0,
        None,
    ...
    (
        38,
        "SCI goods, USD 0, pro bono donation",
        "sci",
        "goods",
        0,
        "USD",
    ...
    (
        40,
        "SCI works, USD 15000, sanitation WASH",
        "sci",
        "works",
        15_000,
        "USD",
    ...
    (
        41,
        "SCI goods, USD 35000, green procurement",
        "sci",
        "goods",
        35_000,
        "USD",
    ...
    (
        42,
        "DGMP goods, 80M XOF, local preference",
        "dgmp",
        "goods",
        80_000_000,
        "XOF",
    ...
    (
        43,
        "SCI goods, USD 20000, sole source + humanitarian",
        "sci",
        "goods",
        20_000,
        "USD",
    ...
    (
        44,
        "SCI services, USD 60000, single source consultant",
        "sci",
        "services",
        60_000,
        "USD",
        ...
        "sci",
        ["open_national", "direct_procurement"],
        9,
        True,
        None,
        1,
    ...
    (
        45,
        "DGMP works, 90M XOF, Kidal urgent repair",
        "dgmp",
        "works",
        90_000_000,
        "XOF",
    ...
    (
        46,
        "SCI goods, negative value edge test",
        "sci",
        "goods",
        -1,
        "USD",
    ...
    (
        49,
        "SCI services Bamako, USD 1000000, programme-level contract",
        "sci",
        "services",
        1_000_000,
        "USD",
    ...
    (
        50,
        "DGMP works Gao 250M XOF humanitarian infrastructure",
        "dgmp",
        "works",
        250_000_000,
        "XOF",
