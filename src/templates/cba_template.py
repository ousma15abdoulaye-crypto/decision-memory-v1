...
def _build_registre_sheet(wb: Workbook, data: Dict):
    ...
    # Headers
    headers = ["N°", "Soumissionnaire", "Date Dépôt", "Heure Dépôt", "Mode Dépôt", "Docs Reçus", "Observation"]
...
def _build_technique_sheet(wb: Workbook, data: Dict):
    ...
    if not criteria:
        criteria = [{"name": "Capacité technique", "weight": 50}, {"name": "Durabilité", "weight": 10}]
