...
def resolve_vendor(name: str, session: Optional[Session] = None) -> Optional[int]:
...
def resolve_item(description: str, session: Optional[Session] = None) -> Optional[int]:
...
def resolve_zone(name: str, session: Optional[Session] = None) -> Optional[str]:
