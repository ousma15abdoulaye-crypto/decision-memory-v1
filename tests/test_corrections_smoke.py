...
def test_missing_fields_separation():
    ...
    assert "TECHNICAL" in pkg.extracted_data["missing_parts"], "Should have TECHNICAL in missing_parts"
    ...
    print(f"✓ missing_extracted_fields: {pkg.extracted_data['missing_extracted_fields']}")
...
def test_no_id_in_supplier_name():
    ...
    assert name == "FOURNISSEUR_INCONNU", f"Empty filename should return FOURNISSEUR_INCONNU, got '{name}'"
