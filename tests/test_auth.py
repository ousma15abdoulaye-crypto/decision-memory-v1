...
def test_register_user():
    ...
    response = client.post(
        "/auth/register",
        json={"email": unique_email, "username": unique_username, "password": "testpass", "full_name": "Test User"},
    )
...
def test_register_duplicate_username():
    ...
    response = client.post(
        "/auth/register",
        json={"email": "another@example.com", "username": "admin", "password": "testpass"},  # Already exists
    )
...
def test_protected_endpoint_no_auth():
    ...
    response = client.post("/api/cases", json={"case_type": "DAO", "title": "Test Case", "lot": None})
