...
class TestCriteriaTableStructure:
    ...
    def test_devise_defaut_xof(self, db_conn, case_draft):
        with db_conn.cursor() as cur:
            ...
            cur.execute("SELECT currency FROM criteria WHERE id = %s", (crit_id,))
    ...
    def test_is_essential_defaut_false(self, db_conn, case_draft):
        with db_conn.cursor() as cur:
            ...
            cur.execute("SELECT is_essential FROM criteria WHERE id = %s", (crit_id,))
...
class TestCriteriaTriggerPoidsDEFERRED:
    def test_insertion_partielle_acceptee_en_draft(self, db_conn, case_draft):
    ...
    def test_trigger_bloque_au_commit_somme_invalide(self, db_conn, case_evaluation):
        """
    ...
    def test_transaction_complete_100pct_acceptee(self, db_conn, case_evaluation):
        """
    ...
    def test_essentiels_exclus_de_la_somme(self, db_conn, case_evaluation):
        """
...
class TestCriteriaIsolationOrg:
    def test_org_ne_voit_pas_criteres_autre_org(self, db_conn, case_draft):
