...
6. Checklist de freeze

CHECKLIST AVANT FREEZE ADR-0004
─────────────────────────────────
...
□ SHA256 calculé et inscrit dans FREEZE_MANIFEST.md
□ Tag git : v3.3.2-freeze-patch3
□ Copie immuable dans docs/freeze/v3.3.2/adrs/ADR-0004.md

7. Décision finale

Cet ADR-0004 est ACCEPTÉ et GELÉ.

Il complète ADR-0003 en introduisant M-SCHEMA-CORE dans la Phase 0
et en documentant l'exception de nommage pour la migration 011.

Il ne remplace pas ADR-0003.
Il ne remplace pas la Constitution V3.3.2.
Il les complète de façon cohérente.

FREEZE : Ce document est gelé.
TAG    : v3.3.2-freeze-patch3
SHA256 : D596D8485FCA54FEBCF2C8C0194E873BE99EE7732E9D9906C17B86AB5F56D293
