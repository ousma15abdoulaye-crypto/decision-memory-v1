...
L'agent PATCH-B doit :
  1. Vérifier alembic heads → m4_patch_a_fix (1 head)  [après merge PR#145 ; avant merge : m4_patch_a_vendor_structure_v410]
...
3. Confirmer alembic heads → m4_patch_a_fix (1 head)  [après merge PR#145 ; avant merge : m4_patch_a_vendor_structure_v410].
