...
- **Tests isolation** : [`tests/integration/test_rls_dm_app_cross_tenant.py`](../../../tests/integration/test_rls_dm_app_cross_tenant.py), [`tests/db_integrity/test_workspace_rls.py`](../../../tests/db_integrity/test_workspace_rls.py).
